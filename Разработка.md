...
- NotificationService: ⏳ Частично реализовано
- RiskService/StatsService: ⏳ Частично реализовано
- REST API Exchanges: ✅ 100% реализовано (4/4 endpoints)
- REST API Pairs: ✅ 100% реализовано (7/7 endpoints)
- REST API Notifications/Stats/Blacklist/Settings: ⏳ Handlers созданы, endpoints не реализованы

**Frontend (React):**
- Структура файлов: ❌ 0% (директория не создана)
- Реализация: ❌ Не начато

**Следующий шаг:** Реализация REST API endpoints для Notifications/Stats/Blacklist/Settings (Приоритет 6.2) или WebSocket типов сообщений (Приоритет 7.2)
...
- ErrInvalidExitSpread - спред выхода должен быть > 0
- ErrExitSpreadTooHigh - спред выхода должен быть < спреда входа
