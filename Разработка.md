...
> **Аудит выполнен (2025-12-03):**
> - ✅ CORS: исправлена проблема wildcard + credentials (теперь проверяется конкретный origin)
> - ✅ CORS: добавлен Access-Control-Max-Age (24 часа кеширования preflight)
> - ✅ CORS: конфигурация origins через CORS_ALLOWED_ORIGINS
> - ✅ Recovery: скрыты детали ошибок от клиента (для безопасности)
> - ✅ Logging: добавлено логирование размера ответа
> - ✅ Auth: добавлен DebugAuth middleware для защиты pprof endpoints
> - ✅ Routes: защита /debug/* endpoints (Basic Auth через DEBUG_USERNAME/DEBUG_PASSWORD)
> - ✅ Routes: исправлена функция ftoa() для отрицательных чисел < 1
> - ✅ Config: добавлены конфигурируемые таймауты (SERVER_READ/WRITE/IDLE_TIMEOUT)
> - ✅ Main: использование таймаутов из конфигурации вместо hardcoded значений
...
> **Аудит выполнен (2025-12-03):**
> - ✅ Dockerfile: добавлен непривилегированный пользователь (USER appuser)
> - ✅ Dockerfile: добавлены LABEL метаданные образа
> - ✅ Dockerfile: добавлен HEALTHCHECK
> - ✅ Dockerfile: оптимизация сборки (-ldflags="-s -w")
> - ✅ docker-compose: секреты вынесены в env_file (.env)
> - ✅ docker-compose: PostgreSQL порт ограничен localhost (127.0.0.1:5432)
> - ✅ docker-compose: Grafana credentials из переменных окружения
> - ✅ docker-compose: добавлен healthcheck для app контейнера
> - ✅ docker-compose: добавлены лимиты ресурсов (CPU/memory)
> - ✅ docker-compose: добавлен log rotation для всех контейнеров
> - ✅ docker-compose: удалён устаревший UPDATE_INTERVAL
> - ✅ Создан .dockerignore для ускорения сборки
> - ✅ .env.example: добавлены GRAFANA_USER/GRAFANA_PASSWORD
